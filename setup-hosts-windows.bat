...
findstr /C:"ecrlink.pcsindonesia.com" "%HOSTS_FILE%" >nul 2>&1
if %errorLevel% equ 0 (
    echo.
    echo WARNING: Entry untuk ecrlink.pcsindonesia.com sudah ada di hosts file!
    echo.
    type "%HOSTS_FILE%" | findstr /C:"ecrlink.pcsindonesia.com"
    echo.
    ...
    findstr /V /C:"ecrlink.pcsindonesia.com" "%HOSTS_FILE%" > "%HOSTS_FILE%.tmp"
...
echo %EDC_IP% ecrlink.pcsindonesia.com >> "%HOSTS_FILE%"
...
ping -n 1 ecrlink.pcsindonesia.com | findstr /C:"Pinging ecrlink.pcsindonesia.com"
